...
set amber = "mpirun -np 16 sander.MPI"

set init = complex
set mini_prefix = 01_minimization
set equi_prefix = 02_equilibration
set prod_prefix = 03_production
set prod_step   = prod
...
# mpirun -np 8 pmemd.MPI -O -i ${mini_prefix}.mdin -p ${init}.parm7 -c ${init}.rst7 -o ${mini_prefix}.mdout -r ${mini_prefix}.rst7 -inf ${mini_prefix}.mdinfo -ref ${init}.rst7
